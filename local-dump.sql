...
--
-- Name: employees; Type: TABLE; Schema: public; Owner: pgbackup
--
...
ALTER TABLE public.employees OWNER TO pgbackup;

--
-- Data for Name: employees; Type: TABLE DATA; Schema: public; Owner: pgbackup
--
